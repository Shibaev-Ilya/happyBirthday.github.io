...
window.onload = function(){
    ...
    imageObj.onload = function(){
        ...
        context.fillText("Вот тебе подарок временный код на временный доступ к курсам на htmlacademy.ru:", 20, 20);
    };
    imageObj.src = "https://www.sunhome.ru/i/wallpapers/190/oboi-programmistov.orig.jpg"; 
};